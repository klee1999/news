        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#contacts"><i class="fa fa-fw fa-arrows-v"></i>Thông tin liên hệ <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="contacts" class="collapse">
                            <li>
                                <a href="index.php?page=contacts">Danh sách</a>
                            </li>
                            <li>
                                <a href="index.php?page=add-contacts">Thêm mới</a>
                            </li>
                        </ul>
                    </li>
