    ...
    <div class="row">
        <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="radio-inline"><input type="radio" name="status" checked="" class="radio-inline" id="tintuc" value="1"> Trung ương</label>
                    <label class="radio-inline"><input type="radio" name="status" class="radio-inline" id="km" value="2"> Tỉnh</label>
                    <!-- <label class="radio-inline"><input type="radio" name="status" class="radio-inline" id="km" value="3"> Sở, ngành</label> -->
                    <label class="radio-inline"><input type="radio" name="status" class="radio-inline" id="km" value="4"> Huyện - Thị xã - Thành phố</label>
                </div>
